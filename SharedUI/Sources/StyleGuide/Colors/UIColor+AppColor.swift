...
public extension UIColor {
    static let backgroundPrimary = UIColor(resource: .primaryBackground)
    static let backgroundSecondary = UIColor(resource: .secondaryBackground)
    static let blueDark = UIColor(.blue)
    static let blueLight = UIColor(resource: .blueLight)
